...
urlpatterns = [
    ...
    path(route="account/users/", view=UserListCreate.as_view(), name="user-list-create"),
    path(route="account/users/<int:user_id>/", view=UserRetrieveUpdatadeDestroy.as_view(), name="user-detail"),
    path(route="account/register/", view=UserRegisterAPIView.as_view(), name="register"),
    path(route="account/register/verify/", view=VerifyOtpAPIView.as_view(), name="verify-code"),
    ...
    path(
    "payment/gateway/<int:subscription_id>/",
